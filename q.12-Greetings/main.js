...
//   each message should be personalized with
//  the person’s name
let friendList = [' wajeeha ', ' tooba ', ' areesha '];
let fGreeting = "well come to at dinner party";
for (let f = 0; f < friendList.length; f++) {
    console.log(fGreeting + friendList[f]);
}
